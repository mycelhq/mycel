...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/copy-editing/SKILL.md
license: MIT
...
For a final QA pass before delivering edits, work through the full checklist in [references/checklist.md](#reference-references-checklist) — covering all seven sweeps plus pre-start and final-check items.
...
- [Plain English Alternatives](#reference-references-plain-english-alternatives): Replace complex words with simpler alternatives
- [Content Refresh](#reference-references-content-refresh): Full checklist, refresh vs. rewrite matrix, and cadence guide
- [Copy Editing Checklist](#reference-references-checklist): Full QA checklist across all seven sweeps
...
**For the full refresh checklist, refresh vs. rewrite decision matrix, and cadence guide**: See [references/content-refresh.md](#reference-references-content-refresh)
...
<a id="reference-references-checklist"></a>
...
<a id="reference-references-plain-english-alternatives"></a>

## Reference: references/plain-english-alternatives.md
...
<a id="reference-references-content-refresh"></a>

## Reference: references/content-refresh.md
