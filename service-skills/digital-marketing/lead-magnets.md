...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/lead-magnets/SKILL.md
license: MIT
...
**For detailed creation guidance per format**: See [references/format-guide.md](#reference-references-format-guide)
...
**For detailed benchmarks by format and industry**: See [references/benchmarks.md](#reference-references-benchmarks)
...
<a id="reference-references-format-guide"></a>
