...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/free-tools/SKILL.md
license: MIT
...
**For detailed tool types and examples**: See [references/tool-types.md](#reference-references-tool-types)

**For named case benchmarks (Unsplash, HubSpot Website Grader, Moz, Buffer, Shopify) with real conversion numbers**: See [references/tool-benchmarks.md](#reference-references-tool-benchmarks)
...
<a id="reference-references-tool-benchmarks"></a>

## Reference: references/tool-benchmarks.md
...
<a id="reference-references-tool-types"></a>

## Reference: references/tool-types.md
