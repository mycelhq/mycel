...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/cro/SKILL.md
license: MIT
...
**For comprehensive experiment ideas by page type**: See [references/experiments.md](#reference-references-experiments)
...
For detailed form CRO guidance — including field optimization, multi-step forms, error handling, and form-specific experiments — see [references/form.md](#reference-references-form).
...
<a id="reference-references-form"></a>

## Reference: references/form.md
