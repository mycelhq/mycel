...
2. **Stop on purpose.** When you need judgment, access, or a verdict:
   ...
   - client input → open a `ClientRequest` (`document` | `answer` | `decision` | `connection`) and/or arm a wait
   - never invent the missing logo / bank statement / decision / OAuth grant
