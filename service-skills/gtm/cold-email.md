...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/cold-email/SKILL.md
license: MIT
attribution: Corey Haines — github.com/coreyhaines31/marketingskills (MIT)
---

<!-- HARVESTED, NOT WRITTEN HERE. 6 upstream file(s) flattened into one; every
...
See [personalization.md](#reference-references-personalization) for the 4-level system and research signals.
...
For the full catalog of frameworks with examples, see [frameworks.md](#reference-references-frameworks).
...
See [subject-lines.md](#reference-references-subject-lines) for the full data.
...
See [follow-up-sequences.md](#reference-references-follow-up-sequences) for cadence, angle rotation, and breakup email templates.
...
- [benchmarks.md](#reference-references-benchmarks) — Reply rates, conversion funnels, expert methods, common mistakes
- [personalization.md](#reference-references-personalization) — 4-level personalization system, research signals
- [subject-lines.md](#reference-references-subject-lines) — Subject line data and optimization
- [follow-up-sequences.md](#reference-references-follow-up-sequences) — Cadence, angles, breakup emails
- [frameworks.md](#reference-references-frameworks) — All copywriting frameworks with examples
...
<a id="reference-references-personalization"></a>

## Reference: references/personalization.md
...
<a id="reference-references-frameworks"></a>
...
<a id="reference-references-subject-lines"></a>

## Reference: references/subject-lines.md
...
<a id="reference-references-follow-up-sequences"></a>

## Reference: references/follow-up-sequences.md
...
<a id="reference-references-benchmarks"></a>

## Reference: references/benchmarks.md
