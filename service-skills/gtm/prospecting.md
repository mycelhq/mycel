...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/prospecting/SKILL.md
license: MIT
...
- **SaaS** → see [references/saas-prospecting.md](#reference-references-saas-prospecting)
- **B2B** → see [references/b2b-prospecting.md](#reference-references-b2b-prospecting)
- **Local SMB** → see [references/local-prospecting.md](#reference-references-local-prospecting)
- **Demand-signal** (find your first customers) → see [references/demand-signals.md](#reference-references-demand-signals)
...
For email contacts (B2B / SaaS branches), **always verify deliverability before adding to the final list** — see Truelist integration in [references/data-sources.md](#reference-references-data-sources). Don't ship leads with invalid or risky emails.

### Phase 4 — Score and prioritize

Apply this rubric for the **SaaS, B2B, and Local SMB** branches. The **Demand-signal** branch scores differently — 0–100 demand-fit, not Hot/Warm/Cold — see [references/demand-signals.md](#reference-references-demand-signals).
...
(SaaS / B2B / Local SMB. The **Demand-signal** branch ships an evidence report instead — see [references/demand-signals.md](#reference-references-demand-signals).)
...
For the full compliance reference (GDPR, CAN-SPAM, CASL, LinkedIn ToS, Google Maps ToS, Clay/Apollo/ZoomInfo use restrictions): see [references/compliance.md](#reference-references-compliance).
...
Full breakdown in [references/data-sources.md](#reference-references-data-sources). Quick picks:
...
<a id="reference-references-saas-prospecting"></a>

## Reference: references/saas-prospecting.md
...
<a id="reference-references-b2b-prospecting"></a>

## Reference: references/b2b-prospecting.md
...
<a id="reference-references-local-prospecting"></a>

## Reference: references/local-prospecting.md
...
See [data-sources.md](#reference-references-data-sources) for setup details.
...
<a id="reference-references-demand-signals"></a>

## Reference: references/demand-signals.md
...
<a id="reference-references-data-sources"></a>
...
<a id="reference-references-compliance"></a>
...
*Upstream also pointed at skills/ad-creative/references/creative-review-page.md, tools/REGISTRY.md, tools/integrations/apollo.md, tools/integrations/browserbase.md, tools/integrations/clay.md, tools/integrations/clearbit.md, tools/integrations/firecrawl.md, tools/integrations/github.md, tools/integrations/hunter.md, tools/integrations/outreach.md, tools/integrations/rb2b.md, tools/integrations/snov.md, tools/integrations/truelist.md, tools/integrations/zoominfo.md. Not carried here: it is a catalogue of third-party tools rather than procedure, and this skill has to hold up without it.*
