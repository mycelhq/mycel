...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/sales-enablement/SKILL.md
license: MIT
...
**For full slide-by-slide guidance**: See [references/deck-frameworks.md](#reference-references-deck-frameworks)
...
**For templates by use case**: See [references/one-pager-templates.md](#reference-references-one-pager-templates)
...
**For the full objection library**: See [references/objection-library.md](#reference-references-objection-library)
...
**For full script templates**: See [references/demo-scripts.md](#reference-references-demo-scripts)
...
<a id="reference-references-deck-frameworks"></a>

## Reference: references/deck-frameworks.md
...
<a id="reference-references-one-pager-templates"></a>

## Reference: references/one-pager-templates.md
...
<a id="reference-references-objection-library"></a>

## Reference: references/objection-library.md
...
<a id="reference-references-demo-scripts"></a>

## Reference: references/demo-scripts.md
...
*Upstream also pointed at tools/REGISTRY.md, tools/integrations/introw.md. Not carried here: it is a catalogue of third-party tools rather than procedure, and this skill has to hold up without it.*
