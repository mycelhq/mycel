...
source: https://github.com/nexu-io/open-design/blob/349748e/skills/web-design-guidelines/SKILL.md
license: Apache-2.0
...
1. Load the pinned guidelines from [`references/guidelines.md`](#reference-references-guidelines) — this is the default, reproducible execution path
...
**Default (pinned):** The vendored copy at [`references/guidelines.md`](#reference-references-guidelines) is the default execution path. It is a pinned snapshot of the upstream guidelines and guarantees the skill produces reproducible results in any runtime environment.
...
1. Load [`references/guidelines.md`](#reference-references-guidelines) as the default source
...
<a id="reference-references-guidelines"></a>

## Reference: references/guidelines.md
