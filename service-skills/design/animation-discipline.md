...
description: "Universal rules for when motion earns its place in a UI and what numbers constrain it. The active `DESIGN.md` decides brand-specific motion personality; this file decides whether m"
source: https://github.com/nexu-io/open-design/blob/349748e/craft/animation-discipline.md
license: Apache-2.0
