---
name: state-coverage
description: "Universal rules for what every interactive surface must render. The active `DESIGN.md` decides how each state looks; this file decides which states must exist and what they must co"
source: https://github.com/nexu-io/open-design/blob/349748e/craft/state-coverage.md
license: Apache-2.0
