---
name: color
description: "Universal color rules applied on top of the active `DESIGN.md`. The design system supplies the palette tokens; this file enforces how to *use* them."
source: https://github.com/nexu-io/open-design/blob/349748e/craft/color.md
license: Apache-2.0
