...
description: "Universal rules for the legal floor of accessibility plus the craft commitments that go beyond it. The active `DESIGN.md` decides brand appearance; this file decides which rules an"
source: https://github.com/nexu-io/open-design/blob/349748e/craft/accessibility-baseline.md
license: Apache-2.0
