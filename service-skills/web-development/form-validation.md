...
description: "Universal rules for form validation lifecycle, error wiring beyond the accessibility baseline, and the schema-as-contract layer that makes the same validation work on the server an"
source: https://github.com/nexu-io/open-design/blob/349748e/craft/form-validation.md
license: Apache-2.0
