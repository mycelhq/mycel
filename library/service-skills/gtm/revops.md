...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/revops/SKILL.md
license: MIT
...
**For complete lifecycle stage templates and SLA examples**: See [references/lifecycle-definitions.md](#reference-references-lifecycle-definitions)
...
**For detailed scoring templates and example models**: See [references/scoring-models.md](#reference-references-scoring-models)
...
**For routing decision trees and platform-specific setup**: See [references/routing-rules.md](#reference-references-routing-rules)
...
**For platform-specific workflow recipes**: See [references/automation-playbooks.md](#reference-references-automation-playbooks)
...
<a id="reference-references-lifecycle-definitions"></a>

## Reference: references/lifecycle-definitions.md
...
<a id="reference-references-scoring-models"></a>

## Reference: references/scoring-models.md
...
<a id="reference-references-routing-rules"></a>
...
<a id="reference-references-automation-playbooks"></a>

## Reference: references/automation-playbooks.md
...
*Upstream also pointed at tools/REGISTRY.md, tools/integrations/activecampaign.md, tools/integrations/apollo.md, tools/integrations/calendly.md, tools/integrations/clearbit.md, tools/integrations/crossbeam.md, tools/integrations/hubspot.md, tools/integrations/introw.md, tools/integrations/salesforce.md, tools/integrations/savvycal.md, tools/integrations/zapier.md. Not carried here: it is a catalogue of third-party tools rather than procedure, and this skill has to hold up without it.*
