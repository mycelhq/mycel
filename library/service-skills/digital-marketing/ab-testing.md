...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/ab-testing/SKILL.md
license: MIT
...
**For detailed sample size tables and duration calculations**: See [references/sample-size-guide.md](#reference-references-sample-size-guide)
...
**For templates**: See [references/test-templates.md](#reference-references-test-templates)
...
<a id="reference-references-sample-size-guide"></a>

## Reference: references/sample-size-guide.md
...
<a id="reference-references-test-templates"></a>

## Reference: references/test-templates.md
