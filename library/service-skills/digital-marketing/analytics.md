...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/analytics/SKILL.md
license: MIT
...
**For comprehensive event lists**: See [references/event-library.md](#reference-references-event-library)
...
**For full event library by business type**: See [references/event-library.md](#reference-references-event-library)
...
**For detailed GA4 implementation**: See [references/ga4-implementation.md](#reference-references-ga4-implementation)
...
**For detailed GTM implementation**: See [references/gtm-implementation.md](#reference-references-gtm-implementation)
...
<a id="reference-references-event-library"></a>

## Reference: references/event-library.md
...
<a id="reference-references-ga4-implementation"></a>

## Reference: references/ga4-implementation.md
...
<a id="reference-references-gtm-implementation"></a>

## Reference: references/gtm-implementation.md
...
*Upstream also pointed at tools/REGISTRY.md, tools/integrations/amplitude.md, tools/integrations/ga4.md, tools/integrations/mixpanel.md, tools/integrations/posthog.md, tools/integrations/segment.md. Not carried here: it is a catalogue of third-party tools rather than procedure, and this skill has to hold up without it.*
