...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/programmatic-seo/SKILL.md
license: MIT
...
**For detailed playbook implementation**: See [references/playbooks.md](#reference-references-playbooks)
...
<a id="reference-references-playbooks"></a>

## Reference: references/playbooks.md
