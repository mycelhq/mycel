...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/churn-prevention/SKILL.md
license: MIT
...
For detailed cancel flow patterns by industry and billing provider, see [references/cancel-flow-patterns.md](#reference-references-cancel-flow-patterns).
...
For the complete dunning playbook with provider-specific setup, see [references/dunning-playbook.md](#reference-references-dunning-playbook).
...
<a id="reference-references-cancel-flow-patterns"></a>

## Reference: references/cancel-flow-patterns.md
...
<a id="reference-references-dunning-playbook"></a>

## Reference: references/dunning-playbook.md
...
*Upstream also pointed at tools/REGISTRY.md, tools/integrations/posthog.md. Not carried here: it is a catalogue of third-party tools rather than procedure, and this skill has to hold up without it.*
