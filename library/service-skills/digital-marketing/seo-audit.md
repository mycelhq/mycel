...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/seo-audit/SKILL.md
license: MIT
...
Check when the site serves multiple languages or regions. Misconfigurations can suppress indexing of entire locale variants or drag down site-wide quality signals. See [International SEO reference](#reference-references-international-seo) for evidence and source URLs.
...
- [AI Writing Detection](#reference-references-ai-writing-detection): Common AI writing patterns to avoid (em dashes, overused phrases, filler words)
- [International SEO](#reference-references-international-seo): Evidence and sources for hreflang, canonical + i18n, sitemaps, URL structure, and content quality across locales
...
<a id="reference-references-international-seo"></a>

## Reference: references/international-seo.md
...
<a id="reference-references-ai-writing-detection"></a>
