...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/ai-seo/SKILL.md
license: MIT
attribution: Corey Haines — github.com/coreyhaines31/marketingskills (MIT)
---

<!-- HARVESTED, NOT WRITTEN HERE. 8 upstream file(s) flattened into one; every
...
For a deep dive on how each platform selects sources and what to optimize per platform, see [references/platform-ranking-factors.md](#reference-references-platform-ranking-factors).
...
See [references/platform-ranking-factors.md](#reference-references-platform-ranking-factors) for the full robots.txt configuration.
...
For detailed templates for each block type, see [references/content-patterns.md](#reference-references-content-patterns).
...
- Reddit discussions (volatile: ~1.8% of ChatGPT citations historically, but nearly wiped from ChatGPT by Aug 2026 retrieval changes — still retrieved elsewhere; see the volatility section in [references/agent-readiness.md](#reference-references-agent-readiness))
...
- Create YouTube content for key how-to queries — models don't watch the video, they read the text layer around it; see [references/youtube-ai-citations.md](#reference-references-youtube-ai-citations) for the full anatomy (transcript, captions, chapters, description, pinned comment)
...
**Audit this layer first**: [references/agent-readiness.md](#reference-references-agent-readiness) — the access/discovery/parseability checklist, free scoring tools (`npx is-agentic`, Frase's checker), Markdown content negotiation + `Link` headers, `llms-full.txt`, and the emerging agent-*actionable* layer (WebMCP).
...
| Recommendation rate | Whether you're on the shortlist, not just cited (see [citations-vs-recommendations.md](#reference-references-citations-vs-recommendations)) | Prompt tracking + mention framing |
...
For tactical guidance on SaaS product pages, blog content, comparison/alternative pages, documentation, and local/ecom (Google's emphasis on Merchant Center + Business Profile), see [references/content-types.md](#reference-references-content-types).
...
<a id="reference-references-platform-ranking-factors"></a>

## Reference: references/platform-ranking-factors.md
...
<a id="reference-references-content-patterns"></a>

## Reference: references/content-patterns.md
...
<a id="reference-references-agent-readiness"></a>

## Reference: references/agent-readiness.md
...
<a id="reference-references-youtube-ai-citations"></a>

## Reference: references/youtube-ai-citations.md
...
<a id="reference-references-okf"></a>

## Reference: references/okf.md
...
<a id="reference-references-citations-vs-recommendations"></a>

## Reference: references/citations-vs-recommendations.md
...
<a id="reference-references-content-types"></a>
...
**Goal:** Get cited in "What is [category]?" and "Best [category]" queries. (Citation is the realistic goal here; being *recommended* in the answer depends on offsite consensus — see [citations-vs-recommendations.md](#reference-references-citations-vs-recommendations).)
...
*Upstream also pointed at skills/ai-seo/SKILL.md, tools/REGISTRY.md. Not carried here: it is a catalogue of third-party tools rather than procedure, and this skill has to hold up without it.*
