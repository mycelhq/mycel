...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/attribution/SKILL.md
license: MIT
...
*Upstream also pointed at tools/REGISTRY.md, tools/integrations/dub-co.md, tools/integrations/ga4.md, tools/integrations/hubspot.md, tools/integrations/posthog.md, tools/integrations/rb2b.md, tools/integrations/salesforce.md, tools/integrations/segment.md, tools/integrations/supermetrics.md. Not carried here: it is a catalogue of third-party tools rather than procedure, and this skill has to hold up without it.*
