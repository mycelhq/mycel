...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/schema/SKILL.md
license: MIT
...
**For complete JSON-LD examples**: See [references/schema-examples.md](#reference-references-schema-examples)
...
<a id="reference-references-schema-examples"></a>

## Reference: references/schema-examples.md
