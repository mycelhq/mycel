...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/public-relations/SKILL.md
license: MIT
attribution: Corey Haines — github.com/coreyhaines31/marketingskills (MIT)
---

<!-- HARVESTED, NOT WRITTEN HERE. 7 upstream file(s) flattened into one; every
...
**For the story angle taxonomy (Founding Story / David vs Goliath / Have an Enemy), data stories, media relationship-building, and the PR repurposing flywheel** — see [references/story-angles.md](#reference-references-story-angles)

**For the reactive newsjacking workflow** — see [references/newsjacking.md](#reference-references-newsjacking)

**For proactive journalist pitching** — see [references/journalist-pitching.md](#reference-references-journalist-pitching)

**For inbound press-request platforms (HARO, Qwoted, etc.)** — see [references/press-platforms.md](#reference-references-press-platforms)

**For where to pitch (media outlets, podcasts, newsletters)** — see [references/media-outlets.md](#reference-references-media-outlets). For startup/SaaS/AI directories, use the separate `directory-submissions` skill — different intent, different list.

**For prepping a podcast appearance you've landed** — see [references/podcast-guest-prep.md](#reference-references-podcast-guest-prep). Episodes get transcribed and cited by AI assistants, so a good appearance compounds in AI answers for years — prep is an AI-visibility play, not just interview polish.
...
Go to [newsjacking.md](#reference-references-newsjacking), run the scoring rubric, draft 2–3 angles, pick the best, draft the pitch.

### "Find journalists who cover [beat]"
Go to [journalist-pitching.md](#reference-references-journalist-pitching), use the discovery checklist + dev-browser to research recent articles, build a scored list.
...
Go to [story-angles.md](#reference-references-story-angles). Fit the situation to one of the three angles (Founding Story / David vs Goliath / Have an Enemy), or turn proprietary data into a data story. Remember: a milestone alone isn't a story — milestone *with narrative* is.

### "Respond to this HARO query"
Go to [press-platforms.md](#reference-references-press-platforms), use the response template, keep it under 200 words.

### "I'm going on [podcast] next week — help me prep"
Go to [podcast-guest-prep.md](#reference-references-podcast-guest-prep): research the show (RSS feed → site → Apple Podcasts → web), extract the recurring threads and host profiles, map the guest's stories onto them, deliver the brief.
...
<a id="reference-references-story-angles"></a>

## Reference: references/story-angles.md
...
- **How to run it:** find the one number in your data that surprises, wrap it in methodology, and package it as a standalone one-pager (not your homepage). See [journalist-pitching.md](#reference-references-journalist-pitching) → the "Data story" template.
...
1. **Follow their beat.** Read their last 5 articles. Know what they cover and what they're tired of covering. (See the discovery checklist in [journalist-pitching.md](#reference-references-journalist-pitching).)
...
- **Every format strengthens the next pitch.** A journalist who can find your thread, article, and podcast on a topic sees a voice in the space — not an opportunist. This is the public trail that makes newsjacking land (see [newsjacking.md](#reference-references-newsjacking) → The Public Trail).
...
<a id="reference-references-newsjacking"></a>

## Reference: references/newsjacking.md
...
5. **Pitch** — draft a tight pitch to 3–5 journalists who cover this beat (see [journalist-pitching.md](#reference-references-journalist-pitching))
...
See also [journalist-pitching.md](#reference-references-journalist-pitching) for the full discovery workflow.
...
<a id="reference-references-journalist-pitching"></a>

## Reference: references/journalist-pitching.md
...
<a id="reference-references-press-platforms"></a>

## Reference: references/press-platforms.md
...
**Decision rule:** if you can sustain 5 hr/week of quality responses for 90 days, this is worth it. If you can only do 1 hr/week, skip it and invest in [proactive pitching](#reference-references-journalist-pitching) instead.
...
<a id="reference-references-media-outlets"></a>

## Reference: references/media-outlets.md
...
- **Don't pitch a publication. Pitch a journalist at that publication.** See [journalist-pitching.md](#reference-references-journalist-pitching) for the discovery workflow.
...
For your specific vertical: Google `"top publications" + "[your industry]"` and run the same scoring exercise from [journalist-pitching.md](#reference-references-journalist-pitching).
...
Store your live, working version in `.agents/media-list.md` (per [journalist-pitching.md](#reference-references-journalist-pitching)).



---

<a id="reference-references-podcast-guest-prep"></a>

## Reference: references/podcast-guest-prep.md
