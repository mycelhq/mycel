---
name: typography-hierarchy-editorial
description: "Extends `typography.md` + `typography-hierarchy.md`. Defines hierarchy behavior for editorial surfaces: long-form articles, magazine layouts, digital guides, editorial landing page"
source: https://github.com/nexu-io/open-design/blob/349748e/craft/typography-hierarchy-editorial.md
license: Apache-2.0
