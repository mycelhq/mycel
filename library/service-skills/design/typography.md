---
name: typography
description: "Universal typography rules that apply on top of any `DESIGN.md`. The active design system decides *which* fonts; this file decides *how* they behave at every size."
source: https://github.com/nexu-io/open-design/blob/349748e/craft/typography.md
license: Apache-2.0
