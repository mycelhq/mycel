...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/emails/SKILL.md
license: MIT
...
**For detailed templates**: See [references/sequence-templates.md](#reference-references-sequence-templates)
...
**For detailed email type reference**: See [references/email-types.md](#reference-references-email-types)
...
**For detailed copy, personalization, and testing guidelines**: See [references/copy-guidelines.md](#reference-references-copy-guidelines)
...
<a id="reference-references-sequence-templates"></a>

## Reference: references/sequence-templates.md
...
<a id="reference-references-email-types"></a>

## Reference: references/email-types.md
...
<a id="reference-references-copy-guidelines"></a>

## Reference: references/copy-guidelines.md
...
*Upstream also pointed at tools/REGISTRY.md, tools/integrations/customer-io.md, tools/integrations/kit.md, tools/integrations/mailchimp.md, tools/integrations/nitrosend.md, tools/integrations/resend.md, tools/integrations/sendgrid.md. Not carried here: it is a catalogue of third-party tools rather than procedure, and this skill has to hold up without it.*
