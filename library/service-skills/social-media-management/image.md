...
source: https://github.com/coreyhaines31/marketingskills/blob/d4ff28a/skills/image/SKILL.md
license: MIT
...
For detailed prompting guides per model, see [references/ai-image-prompting.md](#reference-references-ai-image-prompting).
...
<a id="reference-references-ai-image-prompting"></a>

## Reference: references/ai-image-prompting.md
