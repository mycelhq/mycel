...
// — it is never served as `text/html` from this origin. A live client page is a different door:
// `GET /p/:token` in pages.ts. Spreadsheets and CSV return a capped cell
