 ...
 */
export const SHARED_WORKFLOWS = ["dunning-ladder", "reconcile", "next-touch", "close-figures", "schedule", "win-patterns", "crm-hygiene", "signal-score", "signal-backtest", "content-calendar", "lookalike"] as const;
