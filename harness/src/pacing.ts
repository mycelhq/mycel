...
const CEILING: Record<AccountTier, Ceiling> = {
  free: { invitesPerWeek: 80, messagesPerDay: 25, requestsPerWeek: 5, inmailPerMonth: 0 },
...
export function budgetFor(kind: TouchKind, input: PacingInput): number {
  ...
  // Documented free ceilings (80/week, 25/day) are the target. Engagement can earn a 1.15 reply
  // bonus — cap at `base` so a free account never inherits Premium volume. Profile views stay
