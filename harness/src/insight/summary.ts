...
export async function buildSummary(
  ...
  return {
    ...
    top_paths: paths,
    changes,
    headline: headlineFor(cur.aggregate, funnel, thin, days),
    attention: attentionFor(funnel, changes, thin),
    thin,
...
function headlineFor(cur: Aggregate, funnel: InsightSummary["funnel"], thin: boolean, days: number): string {
 ...
 */
function attentionFor(funnel: InsightSummary["funnel"], changes: Delta[], thin: boolean): string | null {
  if (thin) return null;
