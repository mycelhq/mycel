...
const goodJson = JSON.stringify([
  { id: "problem", label: "Problem", headline: "Still closing the books on Sunday?", primary: "Brightline runs your month-end close so your weekends come back — no spreadsheets, no chase.", cta: "Learn more" },
  { id: "outcome", label: "Outcome", headline: "A clean close, every month", primary: "Founders get books that reconcile themselves. Brightline does the close; you stay on the business.", cta: "Book a call" },
