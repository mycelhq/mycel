...
import type { TouchKind } from "./host";
...
export const LINKEDIN_ACTIONS: Capability[] = [
  ...
  },
  {
    ...
    when: "After ~3 weeks with no answer. Pending invitations pile toward LinkedIn's ~1,500 hard cap; withdrawing clears room for new invites (it does not restore the weekly quota).",
    kind: "write",
    risk: "low",
    touch: null,
